...
/***/ function(module, exports, __webpack_require__) {
	...
	var CityList = React.createFactory(__webpack_require__(168));

	ReactDOM.render(React.createElement(CityList, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var City = React.createFactory(__webpack_require__(169));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Forecast = React.createFactory(__webpack_require__(170));
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    if (this.state.forecast) {
	      ...
	      var h = React.createElement('div', { className: "panel panel-default" }, React.createElement("div", { className: "panel-heading" }, [React.createElement("h3", { className: "panel-title" }, [this.state.forecast.city.name + " " + this.state.forecast.city.country, React.createElement("button", { className: "btn btn-default", style: { 'margin-left': "1em" }, onClick: this.detailsChange }, buttonText)])]));

	      var fc = React.createElement('div', { className: 'panel-body' }, React.createElement(Forecast, { forecast: this.state.forecast.list, showDetails: this.state.showDetails }));
	      return React.createElement('div', { className: 'panel panel-default' }, [h, fc]);
	    } else return React.createElement('h1', { className: 'city' }, this.state.message);
	  }
	});
	...
	module.exports = React.createClass({
	  ...
	  render: function () {
	    ...
	    this.props.forecast.map(function iterator(item) {
	      ...
	      if (days[day]) days[day].push(item);else days[day] = [item];
	    });
	    var elements = [];
	    for (k in days) {
	      var day = days[k];
	      var contents;
	      if (!this.props.showDetails) contents = React.createElement('p', { className: 'bg-success' }, 'TODO: show aggregate');else contents = day.map(function iter2(hour) {
	        var temp = temp = Math.round(10 * hour.main.temp) / 10;
	        return React.createElement('div', { className: 'thumbnail' }, [React.createElement('img', { src: 'http://openweathermap.org/img/w/' + hour.weather[0].icon + '.png' }), React.createElement('div', { className: 'caption' }, React.createElement('p', { className: '' }, hour.weather[0].description), React.createElement('h4', { className: '' }, temp), React.createElement('div', { className: 'label label-default' }, hour.hourTxt))]);
	      });
	      elements.push(React.createElement('div', { className: 'col-md-2 text-center' }, [React.createElement('h4', null, k), contents]));
	    }
